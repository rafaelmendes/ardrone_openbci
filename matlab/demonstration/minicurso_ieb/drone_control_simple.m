...
%         f = (0:N/2-1)*fa/N;
        ...
        S_squared = smooth(circBuff_1.^2, 500)';
        ...
        subplot(3,1,2);
%         plot(t_circBuff, circBuff_1.^2, t_circBuff, S_squared);
        plot(t_circBuff, S_squared, 'Linewidth', 3);
%         hline = refline([0 150]); % plot goal line
%         hline.Color = 'k';
%         hline.LineWidth = 4;
        axis([-inf inf 0 250]);
        xlabel('Time (s)');
        ylabel('Squared Voltage on Pz ');
